...
#define SPLIT_TRANSACTION_IDS_USER \
    ...
    USER_SYNC_LASTKEY_DATA, \
    USER_SYNC_LATIN_EX_DATA, \
    USER_SYNC_OVERLAY_DATA, \
    USER_SYNC_COMPRESSED_DATA, \
    USER_SYNC_ROI_DATA, \
    USER_SYNC_DYNAMIC_KEYMAP_DATA, \
    USER_SYNC_OVERLAY_MAP_DATA, \
    USER_SYNC_FW_UP_QUERY, \
    USER_SYNC_FW_UP_BEGIN, \
    USER_SYNC_FW_UP_CHUNK, \
    USER_SYNC_FW_UP_COMMIT
