...
fontconvert -f~/repos/noto-sans/NotoSans-Regular.ttf "-s${size_lat}" -v _CurrencySigns_  0x20aa 0x20ac 0x20b4 0x20b4 0x2116 0x2116 > "base/fonts/generated/2NotoSans_Regular_CurrencySigns_${size_lat}pt.h"
...
fontconvert -f~/repos/Noto_Sans_Symbols_2/NotoSansSymbols2-Regular.ttf "-s20" -r50 -v _SymbolsAndShapes_ 0x25AC 0x25AC 0x2611 0x2611 > "base/fonts/generated/3NotoSansSymbols2_Regular_SymbolsAndShapes_20pt.h"
fontconvert -f~/repos/Noto_Sans_Symbols_2/NotoSansSymbols2-Regular.ttf "-s20" -r50 -v _Chess_ 0x2654 0x265F > "base/fonts/generated/7NotoSansSymbols2_Regular_Chess_20pt.h"
