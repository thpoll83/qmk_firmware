...
echo "Japanese..."
fontconvert "-ffonts/noto-sans-jp/NotoSansJP-Regular.ttf" "-s${size_jp}" -w500 -v _KangXi_ 0x2f00 0x2f00 0x2f08 0x2f08 0x2f17 0x2f18 0x2f1d 0x2f25 0x2f2b 0x2f2d 0x2f38 0x2f3f 0x2f47 0x2f4a 0x2f54 0x2f55 0x2f65 0x2f65 0x2f75 0x2f75 0x2fa6 0x2fa6 > "base/fonts/generated/7NotoSansJP_Regular_KangXi_${size_jp}pt.h"
fontconvert "-ffonts/noto-sans-jp/NotoSansJP-Regular.ttf" "-s${size_jp}" -w500 -v _Cjk4e2d_ 0x4e2d 0x4e2d > "base/fonts/generated/7NotoSansJP_Regular_Cjk4e2d_${size_jp}pt.h"
fontconvert "-ffonts/noto-sans-jp/NotoSansJP-Regular.ttf" "-s${size_jp}" -w500 -v _Cjk5eff_ 0x5eff 0x5eff > "base/fonts/generated/7NotoSansJP_Regular_Cjk5eff_${size_jp}pt.h"
fontconvert "-ffonts/noto-sans-jp/NotoSansJP-Regular.ttf" "-s${size_jp}" -w500 -v _Cjk96e3_ 0x96e3 0x96e3 > "base/fonts/generated/7NotoSansJP_Regular_Cjk96e3_${size_jp}pt.h"
fontconvert "-ffonts/noto-sans-jp/NotoSansJP-Regular.ttf" "-s${size_jp}" -w500 -v _Hiragana_ 0x3041 0x3096 0x3099 0x309f > "base/fonts/generated/NotoSansJP_Regular_Hiragana_${size_jp}pt.h"
fontconvert "-ffonts/noto-sans-jp/NotoSansJP-Regular.ttf" "-s${size_jp}" -w500 -v _Punct_ 0x3001 0x3002 0x3008 0x3011 > "base/fonts/generated/NotoSansJP_Regular_Punct_${size_jp}pt.h"
fontconvert "-ffonts/noto-sans-jp/NotoSansJP-Regular.ttf" "-s${size_jp}" -w500 -v _Punct2_ 0x30fb 0x30fc > "base/fonts/generated/NotoSansJP_Regular_Punct2_${size_jp}pt.h"

echo "Korean..."
fontconvert "-ffonts/noto-serif-kr/NotoSerifKR-Medium.otf" "-s${size_kr}" -w500 -r51 -v _Vowels_ 0x1161 0x1169 0x116d 0x116e 0x1172 0x1175 > "base/fonts/generated/NotoSerifKR_Regular_Vowels_${size_kr}pt.h"
fontconvert "-ffonts/noto-serif-kr/NotoSerifKR-Medium.otf" "-s${size_kr}" -w500 -v _Consonants_ 0x1100 0x1112 > "base/fonts/generated/NotoSerifKR_Regular_Consonants_${size_kr}pt.h"
