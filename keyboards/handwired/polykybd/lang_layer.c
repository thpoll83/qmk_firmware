...
static const uint8_t REGION_LANGS[NUM_LANG] = {
    // Americas (26): es-AR es-BO ay-BO pt-BR fr-CA en-CA es-CL es-CO es-CR es-DO es-EC es-GT
    //                es-HN es-MX nh-MX es-NI es-PA es-PE qu-PE es-PY gn-PY es-SV en-US nv-US
    //                es-UY es-VE
     78,  88, 153,  32,  45,  77,  84,  81,  90,  87,  85,  86,  92,  42, 155,  95,
     93,  82, 152,  89, 151,  91,   0, 154,  94,  83,
