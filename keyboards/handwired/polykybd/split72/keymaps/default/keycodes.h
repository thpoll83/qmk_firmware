...
enum my_keycodes {
    ...
    KC_LANG_EN = QK_USER_0, KC_LANG_DE, KC_LANG_FR, KC_LANG_ES, KC_LANG_PT, KC_LANG_IT, KC_LANG_TR, KC_LANG_KO, KC_LANG_JA, KC_LANG_AR, KC_LANG_GR, KC_LANG_UA, KC_LANG_RU, KC_LANG_BY, KC_LANG_KZ, KC_LANG_BG, KC_LANG_PL, KC_LANG_RO, KC_LANG_CN, 
    //[[[end]]]
