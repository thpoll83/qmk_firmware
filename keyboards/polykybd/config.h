...
#define SPI_DIVISOR (CPU_CLOCK / 12000000) //EXPERIMENT: 12 MHz SPI (was 10). SSD1315 datasheet max is 10 MHz (tcycle 100ns); 16 MHz tested with flaws, trying 12 MHz. 133/12=11 -> ~12.1 MHz actual
