...
static const display_config_t split42_display_config = {
    ...
    .needs_col_adjustment = false,  // Symmetric layout, no adjustment
    .col_adjustment_start_row = 0,
};

void matrix_init_kb(void) {
    display_register_config(&split42_display_config);
    matrix_init_user();
}
